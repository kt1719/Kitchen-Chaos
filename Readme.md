...
**Kitchen Chaos** is a fast-paced cooking game prototype built by following **Code Monkey’s Kitchen Chaos tutorial series**.  
This version includes the **core single-player gameplay systems** and stops at the end of **Part 1** of the tutorial.
...
- Code Monkey – *Kitchen Chaos (Part 1)*
